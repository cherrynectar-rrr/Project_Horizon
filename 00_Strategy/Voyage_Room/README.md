...
The Voyage Room is Project Horizon's strategic exploration space. It studies long-horizon questions, develops scenarios, tests assumptions and presents recommendations to Project Control.
...
- activate or pause an execution thread;
- allocate time, money or attention;
- edit specialist `STATUS.md` files;
- change `MASTER_STATUS.md`;
- turn a recommendation into an approved route.

Final synthesis and resource allocation belong to the main control thread.
...
- [WEALTH_AND_CAPITAL_STRATEGY.md](./WEALTH_AND_CAPITAL_STRATEGY.md) — long-horizon framework connecting earning power, capital formation, investing and financial freedom; strategic only until Project Control decides execution architecture.
...
- [GERMANY_MSC_DIRECTION_MATCH_MATRIX.md](./GERMANY_MSC_DIRECTION_MATCH_MATRIX.md) — curriculum-first ranking of Germany / TUM MSc application directions against the user's correct Electronic Information Engineering curriculum.
...
- [CONTROL_TO_VOYAGE.md](../../00_Project_Control/CONTROL_TO_VOYAGE.md) — Project Control's read-only-to-Voyage channel for decisions, feedback and research requests.
