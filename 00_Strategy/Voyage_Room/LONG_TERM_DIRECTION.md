...
Build world-class engineering, research and judgment capacity that increases the freedom to choose how to live, where to live and why to work.

Engineering is the primary current vehicle, not a permanent identity constraint. The route should preserve meaningful creation, curiosity, financial resilience, health, relationships, exploration and long-term optionality.
...
This document does not allocate time, activate threads, set deadlines or modify `MASTER_STATUS.md`.

Any recommendation that would materially change the Project Horizon main line, activate or pause a long-term direction, or significantly reallocate resources must be transmitted to Project Control through `VOYAGE_TO_CONTROL.md`.
